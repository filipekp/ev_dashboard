...
?>
<main class="wrap revolution-wrap"><section class="page-hero compact-hero"><div><?php if($vehiclePhoto):?><img class="hero-car-thumb" src="media.php?view=<?= (int)$vehiclePhoto['id']?>" alt=""><?php endif;?></div><div><span class="eyebrow">ŽIVOT VOZIDLA</span><h1><?=h($vehicle['name'])?> Timeline</h1><p>Jízdy, energie, servis, náklady a online události vozidla v jedné chronologii.</p></div><a class="btn primary" href="import.php">＋ Přidat / importovat</a></section>
