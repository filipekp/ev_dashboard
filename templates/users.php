...
<div class="app-modal" id="userEditorModal" data-current-user-id="<?= (int)$me['id'] ?>" hidden aria-hidden="true">
 ...
 <script defer src="assets/pages/users.js?v=<?= (int)@filemtime(__DIR__ . '/../public/assets/pages/users.js') ?>"></script>event.preventDefault();
  });
})();
</script>
